...
mean_climate_risk <- mean(climate_risk_cbsa_stcofips$normalized_inverted_climate_risk)
mean_climate_risk

perc_climate_risk <- quantile(climate_risk_cbsa_stcofips$normalized_inverted_climate_risk, probs = 0.95)
perc_climate_risk

climate_risk_distribution <- density(climate_risk_cbsa_stcofips$normalized_inverted_climate_risk)
