...
##### original weights with EAL score
...
for (i in 1:size[1]) {
  cbsa_data <- c(criteria_all$real_estate_score[i],
                ...
                criteria_all$inverted_n_health_emissions_cost[i],
                criteria_all$normalized_annual_renewable[i],
                criteria_all$inverted_n_eal_score[i] ## EAL score
                  )
  criteria_all$score_og_weights_EAL[i] = weighted.mean(cbsa_data, criteria_weights_owen)
}
...
sheet_write(criteria_all, ss = "https://docs.google.com/spreadsheets/d/1yqjhJvXUcEiC3qiYWkKNlF6NNpYXWg15zZHwmwpS5Q0/edit#gid=0", sheet = "scores+EAL_2_2_23")
```
