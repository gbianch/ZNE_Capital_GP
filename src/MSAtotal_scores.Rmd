...
jpeg(filename = "wt_criteria_client_bar_chart")
ggplot(data = score_tidy, aes(y = reorder(msa_state, FINAL_owen_SCORE), x = criteria_score)) + 
  ...
  guides(fill=guide_legend(title="Criteria (weighted)")) +
   scale_fill_manual(values = c("palevioletred1","#FDB462",  "gold", "#44AA99", "dodgerblue4", "#BC80BD"),
                     labels=c('Climate Risk', 'CO2 Emissions', 'Electricity', "Finances", "Real Estate", "Landlord Policy")) +
