...
```{r}
MSA_n_data_avg_rent <- n_MSA_realEstate %>% 
  select(cbsa, MSA, n_pop_change, n_employ_change, n_avg_occupancy, n_avg_rent_change, n_avg_rent_to_income_inverted, n_income_to_homeprice)

MSA_n_data_med_rent <- n_MSA_realEstate %>% 
  select(cbsa, MSA, n_pop_change, n_employ_change, n_avg_occupancy, n_med_rent_change, n_med_rent_to_income_inverted, n_income_to_homeprice)
```
